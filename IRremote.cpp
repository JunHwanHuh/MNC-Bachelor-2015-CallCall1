...
/*
void IRsend::sendSignal(unsigned long data, int nbits, int company){
	if(company == 1) sendNEC(unsigned long data, int nbits);
	else if(company == 2) sendSony(unsigned long data, int nbits);
	else if(company == 3) sendRC5(unsigned long data, int nbits);
	else if(company == 4) sendRC6(unsigned long data, int nbits);
	else if(company == 5) sendDISH(unsigned long data, int nbits);
	else if(company == 6) sendSharp(unsigned long data, int nbits);
	else if(company == 11) sendSAMSUNG(unsigned long data, int nbits);
	else if(company == 12) sendLG(unsigned long data, int nbits);
	else sendLG(unsigned long data, int nbits);
}
*/
